                ...
                <div className="row min-vh-100 align-items-center align-content-center">
                    ...
                    <div className="col-md-6 mt-5 mt-md-0">
                        <div>
                            ...
                            <button className="btn btn-outline-success text-decoration-none mt-4" onClick={() => addItem(currentItem.id)}><i className="fa fa-cart-plus me-2 fs-5"></i>Add To Cart</button>
                            <Link to="/cart" className="btn btn-success text-decoration-none ms-2 mt-4"><i className="fa fa-shopping-cart me-2 fs-5"></i>Go To Cart</Link>
                        </div>
                    </div>
                </div>
            </div>
